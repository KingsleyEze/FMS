        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillPayables_LineItems_EconomicId",
                        column: x => x.EconomicId,
                        principalTable: "LineItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BillPayables_BankAccounts_FundId",
                        column: x => x.FundId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillReceivable_LineItems_EconomicId",
                        column: x => x.EconomicId,
                        principalTable: "LineItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillPayables_EconomicId",
                table: "BillPayables",
                column: "EconomicId");

            migrationBuilder.CreateIndex(
                name: "IX_BillPayables_FundId",
                table: "BillPayables",
                column: "FundId");

            migrationBuilder.CreateIndex(
                name: "IX_BillReceivable_EconomicId",
                table: "BillReceivable",
                column: "EconomicId");

            migrationBuilder.CreateIndex(
                name: "IX_BillReceivable_FundId",
                table: "BillReceivable",
                column: "FundId");
